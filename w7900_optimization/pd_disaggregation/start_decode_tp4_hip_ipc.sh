...
export VLLM_NIXL_SIDE_CHANNEL_PORT="${VLLM_NIXL_SIDE_CHANNEL_PORT:-5659}"
...
exec python -m vllm.entrypoints.cli.main serve "${MODEL_PATH}" \
  ...
  --enforce-eager \
  --kv-transfer-config '{"kv_connector":"W7900HipIpcConnector","kv_connector_module_path":"w7900_hip_ipc_connector","kv_role":"kv_consumer","kv_load_failure_policy":"fail","kv_buffer_device":"cuda","kv_connector_extra_config":{"backends":["UCX"]}}'
