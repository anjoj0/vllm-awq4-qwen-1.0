...
exec python -m vllm.entrypoints.cli.main serve "${MODEL_PATH}" \
  ...
  --enforce-eager \
  --kv-transfer-config '{"kv_connector":"NixlConnector","kv_role":"kv_producer","kv_load_failure_policy":"fail","kv_buffer_device":"cuda","kv_connector_extra_config":{"backends":["W7900_HIP_IPC"]}}'
