...
/v1/chat/completions and /v1/responses + vision. Generic, not user-specific.
...
Output: test/bench_full_results.json
"""
...
def main():
    ...
    ap.add_argument("--runs", type=int, default=3, help="runs per test")
    args = ap.parse_args()
