...
void launch_mmq_q4_gemm_kmajor_gfx1151(
    const at::Tensor& x,
...
void launch_mmq_q4_gemm_kmajor_wmma_gfx1151(
    const at::Tensor& x,
    const at::Tensor& w_packed_t,
    const at::Tensor& scales_t,
    const at::Tensor& zeros_t,
...
void launch_mmq_q4_gemm_kmajor_wmma_v5_gfx1151(
    const at::Tensor& x,
    const at::Tensor& w_packed_t,
    const at::Tensor& scales_t,
    const at::Tensor& zeros_t,
...
void launch_mmq_q4_gemm_kmajor_wmma_v6_gfx1151(
    const at::Tensor& x,
    const at::Tensor& w_packed_t,
    const at::Tensor& scales_t,
    const at::Tensor& zeros_t,
...
void launch_mmq_q4_gemm_kmajor_wmma_v7_gfx1151(
    const at::Tensor& x,
    const at::Tensor& w_packed_t,
    const at::Tensor& scales_t,
    const at::Tensor& zeros_t,
...
void launch_mmq_q4_gemm_kmajor_wmma_v8_gfx1151(
    const at::Tensor& x,
    const at::Tensor& w_packed_t,
    const at::Tensor& scales_t,
    const at::Tensor& zeros_t,
...
void launch_mmq_q4_gemm_kmajor_wmma_v9_gfx1151(
    const at::Tensor& x,
    const at::Tensor& w_packed_t,
    const at::Tensor& scales_t,
    const at::Tensor& zeros_t,
...
at::Tensor mmq_q4_gemm_kmajor_wmma_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_wmma_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
...
at::Tensor mmq_q4_gemm_kmajor_wmma_v5_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_wmma_v5_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
...
at::Tensor mmq_q4_gemm_kmajor_wmma_v6_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_wmma_v6_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
...
at::Tensor mmq_q4_gemm_kmajor_wmma_v7_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_wmma_v7_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
at::Tensor mmq_q4_gemm_kmajor_wmma_v8_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_wmma_v8_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
at::Tensor mmq_q4_gemm_kmajor_wmma_v9_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_wmma_v9_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
...
at::Tensor mmq_q4_gemm_kmajor_forward(
    ...
    auto out = at::empty({M, N}, x.options());
    launch_mmq_q4_gemm_kmajor_gfx1151(x, w_packed_t, scales_t, zeros_t, out);
    return out;
}
